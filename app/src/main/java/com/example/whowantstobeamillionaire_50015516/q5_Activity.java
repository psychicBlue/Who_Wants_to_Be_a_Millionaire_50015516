...
public class q5_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_q5_);

        String q1 = "Which film did Steven Spielberg win his first Oscar for Best Director?";
        String ans = "Schindler’s List";
        ...
        option1.setText("Jaws");
        option2.setText("Catch Me If You Can");
        option3.setText("E.T.");
        option4.setText("Schindler’s List");
        ...
        confBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                if(text == ans) {
                    ...
                    toast.show();
                    startActivity(new Intent(q5_Activity.this, q6_Activity.class)); //Use intent to move to next question
                } else {
                    Toast toast = Toast.makeText(context, "Wrong Answer!", Toast.LENGTH_SHORT);
                    toast.show();
                    startActivity(new Intent(q5_Activity.this, loseActivity.class)); //Use intent to move to losing screen
                }
            }
        });
    }
