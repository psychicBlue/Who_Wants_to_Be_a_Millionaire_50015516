...
public class q7_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_q7_);

        String q1 = "What short film featured Mickey Mouse’s first appearance?";
        String ans = "Plane Crazy";
        ...
        option1.setText("Plane Crazy");
        option2.setText("Wild Waves");
        option3.setText("The Band Concert");
        option4.setText("The Barnyard Concert");
        ...
        confBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                if(text == ans) {
                    ...
                    toast.show();
                    startActivity(new Intent(q7_Activity.this, q8_Activity.class)); //Use intent to move to next question
                } else {
                    Toast toast = Toast.makeText(context, "Wrong Answer!", Toast.LENGTH_SHORT);
                    toast.show();
                    startActivity(new Intent(q7_Activity.this, loseActivity.class)); //Use intent to move to losing screen
                }
            }
        });
    }
