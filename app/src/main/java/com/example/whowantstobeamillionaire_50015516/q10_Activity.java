...
public class q10_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_q10_);

        String q1 = "Which Star Wars character is partially named after director George Lucas’ son?";
        String ans = "Dexter Jettster";
        ...
        option1.setText("Max Rebo");
        option2.setText("Rick Olié");
        option3.setText("Dexter Jettster");
        option4.setText("Willrow Hood");
        ...
        confBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                if(text == ans) {
                    ...
                    toast.show();
                    startActivity(new Intent(q10_Activity.this, WinActivity.class)); //Use intent to move to next question
                } else {
                    Toast toast = Toast.makeText(context, "Wrong Answer!", Toast.LENGTH_SHORT);
                    toast.show();
                    startActivity(new Intent(q10_Activity.this, loseActivity.class)); //Use intent to move to losing screen
                }
            }
        });
    }
